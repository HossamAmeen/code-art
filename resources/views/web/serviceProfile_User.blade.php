...
<head>
	...
	<!-- services-page -->
	<link rel="stylesheet" href="assets/css/servicesProfile_User-page.css" />
</head>
...
<body>
	...
	<section>
		<div class="service-rovider-User">
			<div class="container-fluid">
				<div class="user-badge">
					<div class="serviceProvider-img">
						<img src="assets/imgs/services-item-2.png" class="circle" width="100px">
					</div>
					<div class="serviceProvider-name">
						<span> <b>اسامة عسكر</b> </span>
					</div>

					<div class="serviceProvider-rating"> <i class="fas fa-star ml-2"></i> التقييم &nbsp; &nbsp; <span
							class="rating-value">80%</span></div>
				</div>
				<div class="row">
					...
					<div class="col-lg-9 col-md-9 col-sm-12">
						<div class="row">
							<div class="col-lg-4 col-md-4 col-sm-6 service-rovider-User-item-col">
								<div class="service-rovider-User-item-div">
									<a class="service-rovider-User-item-href-div" href="service-details.html">
										<div class="service-rovider-User-item service-rovider-User-item-1">
											<img src="./assets/imgs/services-item-2.png" />
											<div class="item-info">
												<p class="item-name">
													<b>تصميم مواقع</b>
												</p>
												<p class="item-provider">
													<span class="item-provider-title">تصميم موقع احترافي </span>
												</p>
											</div>
											<button class="btn order-red order-btn">
												اطلب الأن
											</button>
										</div>
									</a>
							...
							<div class="col-lg-4 col-md-4 col-sm-6 service-rovider-User-item-col">
								<div class="service-rovider-User-item-div">
									<a class="service-rovider-User-item-href-div" href="service-details.html">
										<div class="service-rovider-User-item service-rovider-User-item-2">
											<img src="./assets/imgs/services-item-2.png" />
											<div class="item-info">
												<p class="item-name">
													<b>تصميم مواقع</b>
							...
							<div class="col-lg-4 col-md-4 col-sm-6 service-rovider-User-item-col">
								<div class="service-rovider-User-item-div">
									<a class="service-rovider-User-item-href-div" href="service-details.html">
										<div class="service-rovider-User-item service-rovider-User-item-3">
											<img src="./assets/imgs/services-item-2.png" />
											<div class="item-info">
												<p class="item-name">
													<b>تصميم مواقع</b>
							...
							<div class="col-lg-4 col-md-4 col-sm-6 service-rovider-User-item-col">
								<div class="service-rovider-User-item-div">
									<a class="service-rovider-User-item-href-div" href="service-details.html">
										<div class="service-rovider-User-item service-rovider-User-item-4">
											<img src="./assets/imgs/services-item-2.png" />
											<div class="item-info">
												<p class="item-name">
													<b>تصميم مواقع</b>
							...
							<div class="col-lg-4 col-md-4 col-sm-6 service-rovider-User-item-col">
								<div class="service-rovider-User-item-div">
									<a class="service-rovider-User-item-href-div" href="service-details.html">
										<div class="service-rovider-User-item service-rovider-User-item-5">
											<img src="./assets/imgs/services-item-2.png" />
											<div class="item-info">
												<p class="item-name">
													<b>تصميم مواقع</b>
							...
							<div class="col-lg-4 col-md-4 col-sm-6 service-rovider-User-item-col">
								<div class="service-rovider-User-item-div">
									<a class="service-rovider-User-item-href-div" href="service-details.html">
										<div class="service-rovider-User-item service-rovider-User-item-6">
											<img src="./assets/imgs/services-item-2.png" />
											<div class="item-info">
												<p class="item-name">
													<b>تصميم مواقع</b>
