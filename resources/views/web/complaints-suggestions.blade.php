...
<head>
	...
	<!-- suggestions -->
	<link rel="stylesheet" href="assets/css/complaints-suggestions.css" />
											...
											<div class="col-lg-6 col-md-6 col-sm-12">
												<div class="data-cell">
													<div class="form-group">
														...
														<input type="tel" class="form-control txtBox-name"
													...
													<div class="data-cell">
														<div class="form-group">
															<label for="comments"
																...
																الشكوى</label>
															<textarea class="form-control txtBox-name cmboBox"
