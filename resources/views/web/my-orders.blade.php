									...
									<div class="row">
										...
										<div class="col-lg-4 col-md-5 col-sm-6 div-2">
											<div class="data-cell col-data-3 ">
												<label class="data-cell-label-title">تصميم موقع احترافي</label>
												<br>
												<label class="data-cell-label-category"><i
														class="fas fa-bars pl-3"></i>تصميم مواقع</label>
												<br>
												<label class="data-cell-label-serviceProvider"><i
														class="fas fa-user pl-3"></i>اسامة
													عسكر</label>
											</div>
										</div>
										<div class="col-lg-2 col-md-3 col-sm-6 div-3">
											<div class="data-cell ">
												...
												<br><br>
												<label class="data-cell-label-date">1-1-2019</label>
												<br><br>
												<label class="data-cell-label-price">1223 ريال</label>
											</div>
										</div>
											...
											<div class="data-cell"><br><br>
												<div class="row">
													<div class="col-lg-6 col-md-6 col-sm-6 div-5">
														<a href="order-status.html"><button
