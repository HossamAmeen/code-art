					...
					<div class="addServiceDetails-div">
						...
						<div class="addServiceDetails-div-body">
							<form class="needs-validation" id="signupForm" novalidate
								action="{{url('service-provider/add-service/'.$id)}}" method="POST"
														...
														<div class="col-lg-12 col-md-12 col-sm-12">
															...
															<div class="form-group">
																...
																<input type="number" class="form-control txtBox-name" name="price[]"
																	id="service-price-class-1-form" value="" required>
														...
														<div class="col-lg-12 col-md-12 col-sm-12">
															<div class="form-group">
																...
																<input type="number" class="form-control txtBox-name" name="days[]"
																	id="service-deliveryTime-class-1-form" value=""
																	required>
													...
													<div class="class-col">
															...
															<div class="form-group">
																<label for="service-price-class-2-form"
																	...
																	<span
																		class="required-star"><sup>*</sup></span></label>
																<input type="number" class="form-control txtBox-name"  name="price[]"
																	id="service-price-class-2-form" value="" required>
																<div class="invalid-feedback invalid-lbl"> سعر الخدمة
																	مطلوب </div>
															</div>
														</div>
														<div class="col-lg-12 col-md-12 col-sm-12">
															<div class="form-group">
																...
																<!-- delete required to not valid it -->
																<input type="number" class="form-control txtBox-name" name="days[]"
																	id="service-deliveryTime-class-2-form" value=""
																	required>
																<div class="invalid-feedback invalid-lbl">مدة التسليم
																	مطلوبة</div>
															</div>
													...
													<div class="class-col">
															...
															<div class="form-group">
																<label for="service-price-class-3-form"
																	...
																	<span
																		class="required-star"><sup>*</sup></span></label>
																<input type="number" class="form-control txtBox-name" name="price[]"
																	id="service-price-class-3-form" value="" required>
																<div class="invalid-feedback invalid-lbl"> سعر الخدمة
																	مطلوب </div>
															</div>
														</div>
														<div class="col-lg-12 col-md-12 col-sm-12">
															<div class="form-group">
																...
																<!-- delete required to not valid it -->
																<input type="number" class="form-control txtBox-name" name="days[]"
																	id="service-deliveryTime-class-3-form" value=""
																	required>
																<div class="invalid-feedback invalid-lbl">مدة التسليم
																	مطلوبة</div>
															</div>
										...
										<div class="col-lg-6 col-md-6 col-sm-12">
											<div class="col-lg-12 col-md-12 col-sm-12">
												<div class="form-group">
													...
													<div class="invalid-feedback invalid-lbl"> البرنامج المستخدم مطلوب
													</div>
												</div>
											</div>
										</div>
											...
											<div class="col-lg-12 col-md-12 col-sm-12">
												<div class="form-group">
													...
													<input type="file" class="form-control txtBox-name"
														id="service-deliveryPrice-form" name="image" required>
