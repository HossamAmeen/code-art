				...
				<div class="row">
					<div class="col-lg-3 col-md-12 col-sm-12">
						<div class="user-badge">
							...
							<br>
							<a href="{{url('service-provider/show-categories')}}"><button class="btn btn-success btn-addService"
                        ...
                        @foreach($services as $service)
							<div class="col-lg-12 col-md-12 col-sm-6 userProfile-item-col">
								<div class="userProfile-item-div">
									<div class="userProfile-item @if($service->is_hidden == 1) hiddenItem @endif" >
										<div class="row">
											<div class="col-lg-4 col-md-4 col-sm-12">
												<a class="userProfile-item-href-div" href="{{url('service-provider/edit-service/'.$service->id)}}">
													<img src="{{asset($service->image)}}" height="150" />
												</a>
											</div>
											<div class="col-lg-7 col-md-7 col-sm-12">
												<div class="item-info">
													<a class="userProfile-item-href-div" href="{{url('service-provider/edit-service/'.$service->id)}}">
														...
														<br>
													<p><span class="item-price">{{$service->price}} ريال</span></p>
													</a>
												</div>
											</div>
												...
												<div class="row item-info">
													<div class="col-lg-12 col-md-12 col-sm-4 action-icons-div">
														<div>
															...
															@if($service->is_hidden == 1)
															<a href = "{{url('service-provider/change-service/'.$service->id)}}" >
																<i title="عرض" class="fas fa-eye-slash action-icons"
																></i></a>
																@else 
																<a href = "{{url('service-provider/change-service/'.$service->id)}}" >
																	<i title="اخفاء" class="fas fa-eye action-icons"
																	></i></a>
																@endif
														</div>
													</div>
													<div class="col-lg-12 col-md-12 col-sm-4 action-icons-div">
														<div>
															<a href = "{{url('service-provider/edit-service/'.$service->id)}}" >
													...
													<div class="col-lg-12 col-md-12 col-sm-4 action-icons-div">
														<div>
														<a href = "{{url('service-provider/delete-service/'.$service->id)}}" >	<i title="حذف الخدمة" class="fas fa-trash action-icons"
																data-toggle="modal"
		...
		<div class="modal fade" id="deleteModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle"
			...
			<div class="modal-dialog modal-dialog-centered" role="document">
				<div class="modal-content">
					...
					action="{{url('service-provider/delete-service'.$service->id)}}">
