		...
		<div class="section-settings">
			<div class="settings">
				<div class="container-fluid">
					...
					<div class="">
						<form class="needs-validation" id="profileForm" novalidate action="{{url('service-provider/account')}}" method="POST">
							@csrf
															...
															<div class="data-cell">
																<div class="form-group">
																	<label for="name-accountData"
																		...
																		اسم المستخدم</label>
																	<input type="text" class="form-control txtBox-name" name="name"
																id="name-accountData" value="{{$serviceProvider->name}}" 
																required>
															...
															<div class="data-cell">
																<div class="form-group">
																	...
																	<input type="email" class="form-control txtBox-name" name="email"
																		id="email-accountData" value="{{$serviceProvider->email}}"
																		required>
															...
															<div class="data-cell">
																<div class="form-group">
																	...
																	<input type="number"
																		...
																		value="{{$serviceProvider->phone}}" required>
		...
		<div class="modal fade" id="passwordPopup" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle"
			...
			<div class="modal-dialog modal-dialog-centered" role="document">
				<div class="modal-content">
					<form class="needs-validation" id="profilePasswordForm" novalidate action="{{url('service-provider/account')}}" method="POST">
						@csrf
